    ...
    <Fragment>
        <table className="w-full sm:w-10/12 md:w-9/12 lg:w-7/12 table-auto" onClick={e => e.stopPropagation()}>
            ...
            <tbody>
                ...
                {/*Total area */}
                {propertyData.area.totalArea && <tr className="border-2 border-gray-300">
                ...
                {/*Covered area */}
                {propertyData.area.coveredArea && <tr className="border-2 border-gray-300">
                ...
                {propertyData.kitchenAppliances && (propertyData.residentialPropertyType.toLowerCase() === 'flat' || propertyData.residentialPropertyType.toLowerCase() === 'house') &&
                    <tr className="border-2 border-gray-300">
                        ...
                        <td className="pt-4 pb-4 flex flex-col gap-2">
                            ...
                            {propertyData.kitchenAppliances.details &&
                                <div className="flex justify-center">
                ...
                {/*property type*/}
                {propertyData.flooringTypeArray && (propertyData.residentialPropertyType.toLowerCase() === 'flat' || propertyData.residentialPropertyType.toLowerCase() === 'house') &&
                    <tr className="border-2 border-gray-300">
                ...
                {propertyData.garden && (propertyData.residentialPropertyType.toLowerCase() === 'flat' || propertyData.residentialPropertyType.toLowerCase() === 'house') &&
                    <tr className="border-2 border-gray-300">
                        ...
                        <td className="pt-4 pb-4 flex flex-col gap-2">
                            ...
                            {propertyData.garden.details && <div className="flex justify-center">
