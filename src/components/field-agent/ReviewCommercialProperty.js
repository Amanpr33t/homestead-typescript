                ...
                <div className='pl-1 pr-1 mb-10 w-full flex flex-col place-items-center' >
                    <table className="w-full sm:w-10/12 md:w-9/12 lg:w-7/12 table-auto" onClick={e => e.stopPropagation()}>
                        ...
                        <tbody>
                            ...
                            {property.commercialPropertyType === 'shop' && (property.leasePeriod.years || property.leasePeriod.months) && <tr className="border-2 border-gray-300">
                            ...
                            {property.commercialPropertyType === 'shop' && (property.lockInPeriod.years || property.lockInPeriod.months) && <tr className="border-2 border-gray-300">
