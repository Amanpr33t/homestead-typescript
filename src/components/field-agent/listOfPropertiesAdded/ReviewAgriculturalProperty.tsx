...
const ReviewAgriculturalProperty: React.FC<PropsType> = ({ propertyId, hideReviewPage }) => {
        ...
        <Fragment>
            ...
            {!spinner &&
                <div className="w-full fixed top-16 bg-white pb-2 z-50">
                    <button
                        type='button'
                        className="bg-green-500 hover:bg-green-600 ml-2 mt-2 text-white font-semibold rounded pl-2 pr-2 pt-0.5 h-8 "
                        onClick={hideReviewPage}>Back</button>
                </div>
            }
                                    ...
                                    {property.reservoir.isReservoir &&
                                        <div className="flex flex-col gap-1">
                                            <div className="flex flex-row gap-2">
                                                ...
                                                {property.reservoir.type && <p>{property.reservoir.type[0]}, {property.reservoir.type[1]}</p>}
                                            </div>
