        ...
        <Fragment>
            <div className= " w-full flex justify-center pt-16">
                ...
                <div className="w-full sm:w-10/12 md:w-8/12 lg:w-1/2 justify-center flex flex-wrap gap-10 mt-20">
                    ...
                    <Link to='' className="bg-blue-500 text-white font-medium rounded p-2 h-fit w-fit">Commercial Properties Added</Link>
                    <Link to='' className="bg-blue-500 text-white font-medium rounded p-2 h-fit w-fit">Residential Properties Added</Link>
                </div>
            </div>
        </Fragment>
    )
