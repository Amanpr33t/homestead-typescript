...
const AlertModal: React.FC<AlertPropsType> = (props) => {
    ...
    return (
        <Fragment>
            <div className="fixed z-50 top-0 pt-28 h-screen w-full flex justify-center bg-black bg-opacity-75 backdrop-blur-sm" onClick={routeTo ? routeToPage : alertModalRemover}>
